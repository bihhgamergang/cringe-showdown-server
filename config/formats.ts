...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			// National Dex OU
			'Arcanine-Mega', 'Blissey', 'Chansey', 'Charizard-Mega-X', 'Charizard-Mega-Y', 'Clefable', 'Corviknight', 'Excadrill', 'Ferrothorn',
	...
	},
	{
		...
		mod: 'newnatdexbh',
		ruleset: ['-Nonexistent', 'Standard NatDex', 'Sleep Clause Mod', 'OHKO Clause', 'Evasion Moves Clause', 'Dynamax Clause', '!Obtainable'],
		banlist: [
			// Abilities
			'Arena Trap', 'Huge Power', 'Innards Out', 'Moody',
			'Neutralizing Gas', 'Parental Bond', 'Pure Power', 'Shadow Tag', 'Wonder Guard',
			// Moves
			'Chatter',
		],
		onValidateSet(set) {
	...
	{
		name: "[Gen 8] Vampyralis Playtest",
		threads: [
			`&bullet; <a href="https://www.smogon.com/forums/threads/3672210/">OU Metagame Discussion</a>`,
			`&bullet; <a href="https://www.smogon.com/forums/threads/3672556/">OU Sample Teams</a>`,
			`&bullet; <a href="https://www.smogon.com/forums/threads/3674058/">OU Viability Rankings</a>`,
	...
	},
	{
		...
		desc: `Anything that can be hacked in-game and is usable in local battles is allowed.`,
		threads: [
			`&bullet; <a href="https://www.smogon.com/forums/threads/old-gen-hackmons-megathread.3649618/page-4">USM Pure Hackmons</a>`,
		],
