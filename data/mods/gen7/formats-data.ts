export const FormatsData: {[k: string]: ModdedSpeciesFormatsData} = {
	...
	arcaninemega: {
		randomBattleMoves: ["crunch", "extremespeed", "flareblitz", "hiddenpowergrass", "morningsun", "overheat", "roar", "superpower", "toxic", "wildcharge", "willowisp"],
		randomDoubleBattleMoves: ["extremespeed", "flareblitz", "hiddenpowergrass", "protect", "overheat", "snarl", "superpower", "wildcharge", "willowisp"],
		tier: "OU",
		doublesTier: "DUU",
	},
	poliwag: {
