export const FormatsData: {[k: string]: SpeciesFormatsData} = {
	...
	jynxgalar: {
		randomBattleMoves: ["focusblast", "earthpower", "thunderbolt", "nastyplot", "encore", "trick"],
		randomBattleLevel: 86,
		randomDoubleBattleMoves: ["focusblast", "earthpower", "thunderbolt", "nastyplot", "protect"],
		randomDoubleBattleLevel: 86,
		tier: "NU",
		doublesTier: "(DUU)",
	},
	...
	phemoptera: {
		randomBattleMoves: ["dragonrush", "earthquake", "fireblast", "glare", "megahorn", "poisonjab", "stickyweb", "uturn"],
		randomBattleLevel: 86,
		randomDoubleBattleMoves: ["clangingscales", "dragonrush", "earthquake", "fireblast", "glare", "megahorn", "poisonjab", "spikyshield", "uturn"],
		randomDoubleBattleLevel: 88,
		tier: "OU",
		doublesTier: "(DUU)",
	},
